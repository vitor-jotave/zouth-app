...
export default function AtendimentoSetup({ instance }: Props) {
    ...
    const fetchQrCode = useCallback(async () => {
        ...
        try {
            const res = await fetch(
                `/manufacturer/atendimento/instances/${instance.id}/qr`,
                {
                    headers: {
    ...
    const pollStatus = useCallback(async () => {
        ...
        try {
            const res = await fetch(
                `/manufacturer/atendimento/instances/${instance.id}/status`,
                {
                    headers: {
                        Accept: 'application/json',
                        'X-Requested-With': 'XMLHttpRequest',
    ...
    useEffect(() => {
        ...
        pollRef.current = setInterval(() => {
            pollStatus();
            // Keep retrying QR code fetch until we get one
            if (!qrCode) {
                fetchQrCode();
            }
        }, 3000);
    ...
    }, [polling, pollStatus, fetchQrCode, qrCode]);
            ...
            <div className="mx-auto w-full max-w-2xl p-4 md:p-6">
                <div className="mb-6">
                    ...
                    <p className="mt-1 text-muted-foreground">
                        ...
                        diretamente pelo ZouthAtendimento.
                    </p>
                </div>
                ...
                {!instance && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Crie uma conexão para vincular seu número de
                                WhatsApp ao sistema.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleCreate} className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Use apenas letras, números, hífens e
                                        underscores.
                                    </p>
                                </div>
                                <Button
                ...
                {instance && currentStatus !== 'connected' && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Abra o WhatsApp no celular → Configurações →
