...
export default function CatalogSettings({
    ...
    const handleOnlyLogoChange = (checked: boolean) => {
        settingsForm.setData((data) => ({
            ...data,
            show_logo: true,
            show_brand_name: checked ? false : true,
        }));
    };

    const handleOnlyNameChange = (checked: boolean) => {
        settingsForm.setData((data) => ({
            ...data,
            show_logo: checked ? false : true,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Esta acao ira restaurar todas as cores,
                                        fonte e textos para os valores padrao.
                                    ...
                                    >
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-3 rounded-lg border p-4">
                                                <Label>Exibição da marca</Label>
                                                <div className="grid gap-3 sm:grid-cols-2">
                                                    <label
                                                        htmlFor="only_logo"
                                                        className="flex cursor-pointer items-start gap-3 rounded-md border p-3 transition hover:bg-muted/50"
                                                    >
                                                        <Checkbox
                                                            id="only_logo"
                                                            checked={
                                ...
                                <CardContent className="space-y-4">
                                    <div className="flex flex-wrap items-center gap-4">
                                        {settings.logo_url ? (
                                            ...
                                            <div className="inline-flex min-h-20 max-w-full min-w-40 items-center justify-center rounded-xl border bg-muted p-2.5">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        <RadioGroup
                                            value={
                                                settingsForm.data.layout_preset
                                            }
                                            onValueChange={(value) =>
                                                settingsForm.setData(
                                                    'layout_preset',
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        <p className="text-sm text-muted-foreground">
                                            Configure quais seções aparecem no
                                            catálogo e personalize cada uma.
                                        </p>
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="text-xs text-muted-foreground">
                                                                {section.type ===
                                                                    'hero' &&
                                                                    'Seção de destaque com logo e chamada'}
                                                                {section.type ===
                                                                    'collections' &&
                                        ...
                                        >
                                            ...
                                            <DialogContent>
                                                <DialogHeader>
                                                    ...
                                                    <DialogDescription>
                                                        Um novo link sera gerado
                                                        e o link antigo sera
                                                        invalidado. Todos os
                                                        links compartilhados
                                                        anteriormente pararao de
                                                        funcionar.
                                                    </DialogDescription>
                                                </DialogHeader>
                                                <DialogFooter>
            ...
            <ImageCropDialog
                ...
                aspectRatio={null}
                title="Ajustar logo"
                description="Recorte bem próximo da marca, sem deixar margens sobrando. O catálogo já reserva um espaço retangular para exibir a logo sem cortar."
            />
        </AppLayout>
    );
}
