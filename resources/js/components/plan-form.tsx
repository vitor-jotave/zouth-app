            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="mt-1 flex min-h-[80px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
                        rows={3}
                    />
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            value={data.max_reps}
                            onChange={(e) =>
                                setData('max_reps', e.target.value)
                            }
                            className="mt-1"
                            placeholder="Ilimitado"
                        />
                        <InputError
                            message={errors.max_reps}
                            className="mt-2"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('max_orders_per_month', e.target.value)
                            }
                            className="mt-1"
                            placeholder="Ilimitado"
                        />
                        <InputError
                            message={errors.max_orders_per_month}
                            className="mt-2"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('max_data_mb', e.target.value)
                            }
                            className="mt-1"
                            placeholder="Ilimitado"
                        />
                        <InputError
                            message={errors.max_data_mb}
                            className="mt-2"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('max_files_gb', e.target.value)
                            }
                            className="mt-1"
                            placeholder="Ilimitado"
                        />
                        <InputError
                            message={errors.max_files_gb}
                            className="mt-2"
                        />
                    </div>
                </div>
