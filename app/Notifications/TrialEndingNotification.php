    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->text('emails.onboarding.message-text', [
                'title' => 'Mantenha a coleção em movimento',
                'intro' => 'O teste da '.$this->manufacturer->name.' está perto do fim.',
                'actionLabel' => 'Escolher meu plano',
                'actionUrl' => route('manufacturer.billing.index'),
                'note' => 'Seu trabalho será preservado mesmo se a conta for pausada.',
            ]);
    }
}
